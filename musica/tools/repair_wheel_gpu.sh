...
for whl in "$2"/*.whl; do
  ...
  patchelf --replace-needed libcudart-b5a066d7.so.12.2.140 libcudart.so.12 _musica*.so
  patchelf --replace-needed libcublas-e779a79d.so.12.2.5.6 libcublas.so.12 _musica*.so
  patchelf --replace-needed libcublasLt-fbfbc8a1.so.12.2.5.6 libcublasLt.so.12 _musica*.so
