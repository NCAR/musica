...
void bind_mechanism_configuration(py::module_ &mechanism_configuration)
{
  ...
  py::class_<Species>(mechanism_configuration, "_Species")
      ...
      .def_readwrite("constant_concentration_mol_m3", &Species::constant_concentration_mol_m3)
      .def_readwrite("constant_mixing_ratio_mol_mol", &Species::constant_mixing_ratio_mol_mol)
