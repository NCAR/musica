...
def extract_data(params, state, env, bin_data, time_array):
    ...
    def _extract_bin_data(data, key):
        result = []
    ...
    def _extract_scalar_bin_data(data, key):
        result = []
        for data_step in data:
            step_data = []
            for i in range(nbin):
