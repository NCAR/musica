...
namespace
{
  ...
  mechanism_configuration::Mechanism CreateCloudChemistryMechanism()
  {
    ...
    r1a.forward_rate_constants = { { "CLOUD", types::Arrhenius{ .A = c_H2O_M * (7.45e7 / 13.0), .C = 4430.0 } } };
    ...
    r1b.rate_constants = { { "CLOUD", types::Arrhenius{ .A = c_H2O_M * 2.4e6, .C = 4430.0 } } };
    ...
    r2.rate_constants = { { "CLOUD", types::Arrhenius{ .A = c_H2O_M * 3.75e5, .C = 5530.0 } } };
    ...
    r3.rate_constants = { { "CLOUD", types::Arrhenius{ .A = c_H2O_M * 1.59e9, .C = 5280.0 } } };
    ...
    aerosol.constraints = {
      ...
      // Kw: H2O ⇌ H+ + OH-
      dissolved_eq({ "H2O" }, { "Hp", "OHm" }, "OHm", types::Equilibrium{ .A = 1e-14 / (c_H2O_M * c_H2O_M), .C = 0.0 }),
      // Ka1: SO2_aq ⇌ HSO3- + H+
      dissolved_eq({ "SO2_aq" }, { "HSO3m", "Hp" }, "HSO3m", types::Equilibrium{ .A = 1.7e-2 / c_H2O_M, .C = 2090.0 }),
      // Ka2: HSO3- ⇌ SO3-- + H+
      dissolved_eq({ "HSO3m" }, { "SO3mm", "Hp" }, "SO3mm", types::Equilibrium{ .A = 6.0e-8 / c_H2O_M, .C = 1120.0 }),
...
TEST(MiamBuilder, InvalidSpeciesName)
{
  ...
  bad_rxn.rate_constants = { { "CLOUD", types::Arrhenius{ .A = 1.0 } } };
...
TEST(MiamBuilder, DissolvedReversibleReactionProcess)
{
  ...
  rxn.forward_rate_constants = { { "CLOUD", types::Arrhenius{ .A = 1e6 } } };
