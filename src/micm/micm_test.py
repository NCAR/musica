...
solver = micm.create_micm("/Users/alexgarza/Documents/CSCE482/musica/src/micm/configs/chapman")  
micm.micm_solve(solver, time_step, temperature, pressure, concentrations)
