...
if(MUSICA_ENABLE_CARMA)
  set(MUSICA_ENABLE_CARMA_INFO "ON (repo: ${CARMA_GIT_REPOSITORY} tag: ${CARMA_GIT_TAG})")
else()
  set(MUSICA_ENABLE_CARMA_INFO "OFF")
endif()

if(MUSICA_ENABLE_MIAM)
  set(MUSICA_ENABLE_MIAM_INFO "ON (repo: ${MIAM_GIT_REPOSITORY} tag: ${MIAM_GIT_TAG})")
else()
  set(MUSICA_ENABLE_MIAM_INFO "OFF")
endif()
