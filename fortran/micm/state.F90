...
#define ASSERT( expr ) call assert( expr, __FILE__, __LINE__ )
  ...
  interface
    ...
    subroutine get_species_ordering_c(state, output, error) &
    ...
    subroutine get_user_defined_rate_parameters_ordering_c(state, output, error) &
...
contains
  ...
  function constructor(micm, number_of_grid_cells, error)  result( this )
    ...
    call get_species_ordering_c(this%ptr, mapping, error_c)
