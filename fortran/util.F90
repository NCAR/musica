...
module musica_util
   ...
   interface
      subroutine create_string_c( string, str ) bind(c, name="CreateString")
         import :: string_t_c, c_char
         character(kind=c_char, len=1), intent(in) :: string(*)
         type(string_t_c), intent(out) :: str
      end subroutine create_string_c
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   function mapping_constructor_from_data( name, index ) result( new_mapping )
      ...
      allocate( new_mapping )
      call create_string_c( to_c_string( name ), new_mapping%mapping_c_%name_ )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   subroutine mapping_assign_mapping_t_c( to, from )
      ...
      call create_string_c( name, to%mapping_c_%name_ )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   function mappings_constructor_from_mapping_t_array( mappings ) &
      ...
      do i = 1, size( mappings )
         call create_string_c( to_c_string( mappings(i)%name() ), &
            mappings_c(i)%name_ )
