...
const { reaction_types } = require('./mechanism_configuration/reaction_types.js');
...
const mechanism_configuration = {
	types,
	reaction_types,
	Mechanism,
};

Object.assign(addon, { micmSolver, mechanism_configuration });
