...
class MICM {
    ...
    constructor({
        ...
        // Create native MICM instance from either config path or mechanism object
        const firstArg = mechanism !== null ? mechanism : config_path;
        this._nativeMICM = new addon.MICM(firstArg, solver_type);
